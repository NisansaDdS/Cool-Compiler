...
@.strs0 = private unnamed_addr constant [15 x i8] c"Hello, world.
\00", align 1
@.strs1 = private unnamed_addr constant [10 x i8] c"Hello, K.\00", align 1
...
entry:
    ...
    %owner0 = alloca %struct.obj_IO*, align 4
    ...
    store %struct.obj_IO* %call0, %struct.obj_IO** %owner0, align 4
    ...
    %call1 = call %struct.obj_String* %callee.knr.cast1(i8* getelementptr inbounds ([15 x i8]* @.strs0, i32 0, i32 0))
    store %struct.obj_String* %call1, %struct.obj_String** %local_2, align 4
    %local_4 = load %struct.obj_IO** %owner0, align 4
    ...
    %local_9 = load %struct.obj_IO** %owner0, align 4
    ...
    %owner1 = alloca %struct.obj_IO*, align 4
    %local_12 = load %struct.obj_IO* (...)** getelementptr inbounds (%struct.class_IO* @the_class_IO, i32 0, i32 1), align 4
    %callee.knr.cast2 = bitcast %struct.obj_IO* (...)* %local_12 to %struct.obj_IO* ()*
    %call3 = call %struct.obj_IO* %callee.knr.cast2()
    store %struct.obj_IO* %call3, %struct.obj_IO** %owner1, align 4
    %local_13 = alloca %struct.obj_String*, align 4
    %local_14 = load %struct.obj_String* (...)** getelementptr inbounds (%struct.class_String* @the_class_String, i32 0, i32 1), align 4
    %callee.knr.cast3 = bitcast %struct.obj_String* (...)* %local_14 to %struct.obj_String* (i8*)*
    %call4 = call %struct.obj_String* %callee.knr.cast3(i8* getelementptr inbounds ([10 x i8]* @.strs1, i32 0, i32 0))
    store %struct.obj_String* %call4, %struct.obj_String** %local_13, align 4
    %local_15 = load %struct.obj_IO** %owner1, align 4
    %local_16 = getelementptr inbounds %struct.obj_IO* %local_15, i32 0, i32 0
    %local_17 = load %struct.class_IO** %local_16, align 4
    %local_18 = getelementptr inbounds %struct.class_IO* %local_17, i32 0, i32 3
    %local_19 = load %struct.obj_IO* (%struct.obj_IO*, %struct.obj_Object*)** %local_18, align 4
    %local_20 = load %struct.obj_IO** %owner1, align 4
    %local_21 = load %struct.obj_String** %local_13, align 4
    %local_22 = bitcast %struct.obj_String* %local_21 to %struct.obj_Object*
    %call5 = call %struct.obj_IO* %local_19(%struct.obj_IO* %local_20, %struct.obj_Object* %local_22)
    %local_23 = load %struct.obj_Object* (...)** getelementptr inbounds (%struct.class_Object* @the_class_Object, i32 0, i32 1), align 4
    %callee.knr.cast4 = bitcast %struct.obj_Object* (...)* %local_23 to %struct.obj_Object* ()*
    %call_6 = call %struct.obj_Object* %callee.knr.cast4()
    ret %struct.obj_Object* %call_6
}
